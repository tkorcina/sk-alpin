...
- [x] Význam polí v Nastavení upřesněn: **Motto** = text v hero bloku nad tlačítkem „Podívejte se na naše akce“, **Popisek webu** = pouze meta description (na webu se nezobrazuje), **Název webu** = title okna.
